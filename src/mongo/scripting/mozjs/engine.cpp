...
void MozJSScriptEngine::interrupt(unsigned opId) {
    stdx::lock_guard<std::mutex> intLock(_globalInterruptLock);
...
void MozJSScriptEngine::interruptAll() {
    stdx::lock_guard<std::mutex> interruptLock(_globalInterruptLock);
...
void MozJSScriptEngine::registerOperation(OperationContext* opCtx, MozJSImplScope* scope) {
    stdx::lock_guard<std::mutex> giLock(_globalInterruptLock);
