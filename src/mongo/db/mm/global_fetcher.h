 ...
 *
 * This class subclasses AbstractGlobalFetcher which takes care of scheduling the Fetcher and
 * `getMore` commands, and handles restarting on errors.
 */
class GlobalFetcher : public AbstractOplogFetcher {
    MONGO_DISALLOW_COPYING(GlobalFetcher);
...
private:
    ...
    /**
     * This function is run by the AbstractGlobalFetcher on a successful batch of oplog entries.
     */
